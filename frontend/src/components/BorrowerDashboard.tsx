...
<div>
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-400/30 text-emerald-200 text-xs font-semibold uppercase tracking-wider mb-4">
<span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
            Tier 3 Verified Enterprise
          </div>
<h1 className="text-3xl sm:text-4xl md:text-5xl font-editorial font-bold tracking-tight text-white leading-tight mb-4">
            Scaling with Purpose, Amina
          </h1>
<p className="text-emerald-100/90 text-base sm:text-lg leading-relaxed max-w-xl font-light">
...
<div className="mt-8 pt-6 border-t border-emerald-800/60 flex flex-wrap items-center gap-6 text-xs text-emerald-200/80">
<div className="flex items-center gap-2">
...
<span>Institutional Credit Underwriting</span>
</div>
<div className="flex items-center gap-2">
...
<div className="flex items-center gap-2">
<span className="font-editorial-italic text-sm text-emerald-300">“Small businesses build brighter tomorrows.”</span>
</div>
</div>
</div>
...
<span className="block text-2xl sm:text-3xl font-editorial font-bold text-amber-200/90 tracking-wide drop-shadow">
...
<div>
<h3 className="text-2xl font-bold font-editorial text-slate-900">Your Loan History</h3>
<p className="text-xs text-slate-500 mt-0.5">Transparent record of all micro-credit disbursements and completed terms</p>
</div>
<button onClick={() => setActiveTab("Facilities")} className="inline-flex items-center text-sm font-semibold text-[#0c3b2e] hover:text-emerald-700 transition-colors">
<span>View All</span>
...
<td className="py-4 pl-2 font-medium text-slate-900">Apr 12, 2024</td>
<td className="py-4 px-4 font-semibold text-slate-900 font-editorial text-base">$150.00</td>
<td className="py-4 px-4 text-slate-600">Stock inventory</td>
...
{/*  Row 2  */}
<tr className="hover:bg-slate-50/70 transition-colors">
<td className="py-4 pl-2 font-medium text-slate-900">Mar 3, 2024</td>
<td className="py-4 px-4 font-semibold text-slate-900 font-editorial text-base">$50.00</td>
<td className="py-4 px-4 text-slate-600">Raw materials</td>
<td className="py-4 pr-2 text-right">
<span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200/60">
<svg className="w-3 h-3 mr-1 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
<polyline points="20 6 9 17 4 12"></polyline>
...
{/*  Row 3  */}
<tr className="hover:bg-slate-50/70 transition-colors">
<td className="py-4 pl-2 font-medium text-slate-900">Jan 18, 2024</td>
<td className="py-4 px-4 font-semibold text-slate-900 font-editorial text-base">$75.00</td>
<td className="py-4 px-4 text-slate-600">Equipment repair</td>
<td className="py-4 pr-2 text-right">
<span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200/60">
<svg className="w-3 h-3 mr-1 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
<polyline points="20 6 9 17 4 12"></polyline>
...
{/*  Row 4  */}
<tr className="hover:bg-slate-50/70 transition-colors">
<td className="py-4 pl-2 font-medium text-slate-900">Dec 2, 2023</td>
<td className="py-4 px-4 font-semibold text-slate-900 font-editorial text-base">$50.00</td>
<td className="py-4 px-4 text-slate-600">Initial stock</td>
<td className="py-4 pr-2 text-right">
<span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200/60">
<svg className="w-3 h-3 mr-1 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
<polyline points="20 6 9 17 4 12"></polyline>
...
<div>
<span className="text-xs font-bold uppercase tracking-widest text-emerald-700">Spotlight &amp; Impact</span>
<h3 className="text-2xl font-bold font-editorial text-slate-900 mt-1">Enterprise Growth &amp; Marketplace Stories</h3>
</div>
<button onClick={() => { alert("Loading Impact Report..."); }} className="text-xs font-bold text-[#0c3b2e] hover:underline">Quarterly Impact Report →</button>
</div>
...
<div className="absolute top-3 left-3 bg-[#0c3b2e]/90 backdrop-blur-sm text-white px-2.5 py-1 rounded text-xs font-semibold">
              Kigali Commerce Hub
            </div>
</div>
<div className="md:col-span-5 p-6 flex flex-col justify-between">
<div>
<p className="text-[11px] font-bold uppercase tracking-wider text-emerald-800">Digital Transformation</p>
<h4 className="text-lg font-bold font-editorial text-slate-900 mt-1 leading-snug">
...
<span className="text-xs font-medium text-slate-500">Read 4 min case study</span>
<span className="text-xs font-bold text-[#0c3b2e] flex items-center gap-1 group-hover:translate-x-1 transition-transform">
...
<h5 className="text-sm font-bold text-slate-900">Tips for Growth</h5>
<p className="text-xs text-slate-500 mt-1 leading-relaxed">Learn how to manage seasonal cash flow and grow sustainably.</p>
</div>
<button onClick={() => setActiveTab("Support")} className="mt-4 inline-flex items-center text-xs font-bold text-[#0c3b2e] hover:text-emerald-800">
...
<h5 className="text-sm font-bold text-slate-900">Document Templates</h5>
<p className="text-xs text-slate-500 mt-1 leading-relaxed">Download invoices &amp; ledger forms to accelerate approvals.</p>
</div>
<button onClick={() => setActiveTab("Documents")} className="mt-4 inline-flex items-center text-xs font-bold text-[#0c3b2e] hover:text-emerald-800">
...
<h5 className="text-sm font-bold text-slate-900">Merchant Network</h5>
<p className="text-xs text-slate-500 mt-1 leading-relaxed">Connect with 1,200+ fellow entrepreneurs in your region.</p>
</div>
<button onClick={() => setActiveTab("Network")} className="mt-4 inline-flex items-center text-xs font-bold text-[#0c3b2e] hover:text-emerald-800">
...
<span className="text-xs font-bold uppercase tracking-wider text-emerald-300">Action Rail</span>
<span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-400 text-[#0c3b2e]">Fast-Track</span>
</div>
<h3 className="text-2xl font-bold font-editorial tracking-tight text-white mb-2">
          Request New Facility
        </h3>
<p className="text-emerald-100/80 text-xs sm:text-sm leading-relaxed mb-5">
...
<span className="text-emerald-200">Desired Amount</span>
<span className="font-bold text-white text-base font-editorial">$250.00</span>
</div>
...
<div>
<span className="text-[10px] text-emerald-300 block">Term Length</span>
<span className="font-semibold text-white">60 Days</span>
</div>
<div>
<span className="text-[10px] text-emerald-300 block">Est. Bi-Weekly</span>
<span className="font-semibold text-white">$65.00</span>
</div>
</div>
</div>
<div className="mt-4 mb-2">
  <label className="text-[10px] text-emerald-300 block mb-1">Requested Amount (USD)</label>
  <input 
    type="number" 
    value={amount} 
    onChange={(e) => setAmount(e.target.value)} 
    placeholder="250.00"
    className="w-full bg-white/10 border border-emerald-700 rounded-lg px-3 py-2 text-white placeholder-emerald-400/50 outline-none focus:border-emerald-400"
  />
</div>
{error && <p className="text-red-400 text-xs mb-2">{error}</p>}
{successMsg && <p className="text-emerald-300 text-xs mb-2">{successMsg}</p>}
<button 
  onClick={handleApply}
  disabled={isLoading}
  ...
  type="button"
>
<span>{isLoading ? 'Processing...' : `Apply for $${amount || '0'} Now`}</span>
...
<div className="flex items-center justify-between mb-4">
<h4 className="text-base font-bold font-editorial text-slate-900">Credit Progress Ladder</h4>
<span className="text-xs font-semibold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full">Level 3 of 5</span>
</div>
<p className="text-xs text-slate-500 mb-5">Each prompt loan repayment automatically unlocks increased capital thresholds.</p>
...
<div>
<div className="flex items-center gap-2">
<span className="text-xs font-bold text-[#0c3b2e]">Level 3: Enterprise Merchant</span>
<span className="text-[11px] font-bold text-[#0c3b2e] bg-emerald-50 px-1.5 py-0.2 rounded border border-emerald-200">$350 Limit</span>
</div>
<p className="text-[11px] text-emerald-700 font-medium mt-0.5">Current Active Tier (Good Standing)</p>
</div>
</div>
...
<span className="text-[10px] font-bold uppercase tracking-wider text-emerald-800 block">Dedicated Officer</span>
<p className="text-sm font-bold text-slate-900">Kofi Mensah</p>
<p className="text-xs text-slate-500">Available Mon-Fri 08:00-18:00</p>
</div>
...
<div>
<h4 className="text-lg sm:text-xl font-bold font-editorial tracking-tight text-white">
